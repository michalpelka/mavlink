...
/** @brief RC control override type */
#ifndef HAVE_ENUM_MAV_OVERRIDE_TYPE
#define HAVE_ENUM_MAV_OVERRIDE_TYPE
typedef enum MAV_OVERRIDE_TYPE
{
	MAV_OVERRIDE_IGNORE=0, /* This override message will be ignored | */
	MAV_OVERRIDE_MAVLINK=1, /* MAVLINK has priority due to RC | */
	MAV_OVERRIDE_RC=2, /* RC priorirty, message will be overided only if RC stick is in neutral | */
	MAV_OVERRIDE_ADD=3, /* MAVLINK ovveride will be added to RC | */
	MAV_OVERRIDE_TYPE_ENUM_END=4, /*  | */
} MAV_OVERRIDE_TYPE;
#endif
...
#include "./mavlink_msg_rc_offboard.h"
