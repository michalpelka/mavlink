...
static void mavlink_test_rc_offboard(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
	mavlink_message_t msg;
        uint8_t buffer[MAVLINK_MAX_PACKET_LEN];
        uint16_t i;
	mavlink_rc_offboard_t packet_in = {
		17.0,45.0,73.0,101.0,53,120,187,254,65,132
    };
	mavlink_rc_offboard_t packet1, packet2;
        memset(&packet1, 0, sizeof(packet1));
        	...
        	packet1.target_system = packet_in.target_system;
        	packet1.target_component = packet_in.target_component;
        	packet1.throttle_mode = packet_in.throttle_mode;
        ...
        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_rc_offboard_encode(system_id, component_id, &msg, &packet1);
	mavlink_msg_rc_offboard_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_rc_offboard_pack(system_id, component_id, &msg , packet1.target_system , packet1.target_component , packet1.throttle , packet1.pitch , packet1.roll , packet1.yaw , packet1.throttle_mode , packet1.pitch_mode , packet1.roll_mode , packet1.yaw_mode );
	mavlink_msg_rc_offboard_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_rc_offboard_pack_chan(system_id, component_id, MAVLINK_COMM_0, &msg , packet1.target_system , packet1.target_component , packet1.throttle , packet1.pitch , packet1.roll , packet1.yaw , packet1.throttle_mode , packet1.pitch_mode , packet1.roll_mode , packet1.yaw_mode );
	mavlink_msg_rc_offboard_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
	...
	mavlink_msg_rc_offboard_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
        
        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_rc_offboard_send(MAVLINK_COMM_1 , packet1.target_system , packet1.target_component , packet1.throttle , packet1.pitch , packet1.roll , packet1.yaw , packet1.throttle_mode , packet1.pitch_mode , packet1.roll_mode , packet1.yaw_mode );
	mavlink_msg_rc_offboard_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
}
...
static void mavlink_test_pixhawk(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
	...
	mavlink_test_rc_offboard(system_id, component_id, last_msg);
}
